// ============================================================================
// BLOQUE 1: CÓDIGO ORIGINAL INTACTO (Controla el shortcode principal)
// ============================================================================
...
if (typeof jQuery !== 'undefined') {
    jQuery(document.body).on('added_to_cart', function(event, fragments, cart_hash, $button) {
        if ($button && ($button.closest('#tc-checkout-modal').length > 0 || $button.closest('#tc-sidebar-checkout-modal').length > 0)) {
